...
- **Custom Styling:** Enhanced visual appeal using Qt Style Sheets (CSS-like styling) for buttons and display fields.

## 🛠️ Technologies Used

- **Language:** C++
- **Framework:** Qt 6.x / 5.x
- **Development Tools:** Qt Creator, Qt Designer

## 📂 Project Structure

- `mainwindow.cpp` / `.h`: Contains the core logic for mathematical operations and signal/slot management.
- `mainwindow.ui`: The XML-based layout file for the user interface.
